...
const (
	...
	MSG_HELP = "\nCommands:\n" +
		CMD_CREATE + " Alice - Make a chat room named Alice\n" +
		CMD_LIST + " - Show all the available chat rooms\n" +
		CMD_JOIN + " Alice - Join a chat room with Alice and start chatting\n" +
		CMD_LEAVE + " - Move away/leave the active chat room\n" +
		CMD_HELP + " - Show all available command\n" +
		CMD_NAME + " Alice - changes your name to chat\n" +
		CMD_QUIT + " - Close the chat\n\n"
